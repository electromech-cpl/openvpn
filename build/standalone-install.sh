...
# Description
echo "This script will install ElectromechVPN-UI and all the dependencies on your local environment. No containers will be used."
...
read -p "Would you like to build ElectromechVPN-UI and qrencode binaries? (y/n) " -n 1 -r
echo    # move to a new line
if [[ $REPLY =~ ^[Yy]$ ]]
then
    # Install ElectromechVPN-UI and qrencode
    echo "Installing ElectromechVPN-UI and qrencode"
    ...
    # Packing ElectromechVPN-ui
    cd ../
    echo "Building and packing ElectromechVPN-UI"
    # Execute bee pack
